...
export const useTerminalStore = defineStore('terminal', () => {
  ...
  const getCommandHistory = computed(() => (connectionId) => commandHistory.value.get(connectionId) || [])
  ...
  const completeCommand = (commandData) => {
    ...
    if (commandInfo) {
      ...
      console.log(`✅ [TERMINAL-STORE] 命令执行完成:`, { commandId, executionTime: commandInfo.executionTime })
    }
  }
