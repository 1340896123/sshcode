...
export const offEvent = (eventType, handler) => globalEventManager.off(eventType, handler);

export const waitForEvent = (eventType, timeout) => globalEventManager.waitFor(eventType, timeout);

export const clearAllEvents = () => globalEventManager.clear();
